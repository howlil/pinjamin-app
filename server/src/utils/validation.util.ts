...
export class ValidationUtil {
  static validate<T extends AnyZodObject | ZodEffects<AnyZodObject>>(
    schema: T,
    data: any
  ): z.infer<T> {
  ...
  static validateBody<T extends AnyZodObject | ZodEffects<AnyZodObject>>(
    req: Request,
    schema: T
  ): z.infer<T> {
  ...
  static validateQuery<T extends AnyZodObject | ZodEffects<AnyZodObject>>(
    req: Request,
    schema: T
  ): z.infer<T> {
  ...
  static validateParams<T extends AnyZodObject | ZodEffects<AnyZodObject>>(
    req: Request,
    schema: T
  ): z.infer<T> {
