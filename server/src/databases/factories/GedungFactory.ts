...
import { PrismaClient, Gedung } from '@prisma/client';

export class GedungFactory extends Factory<Gedung> {
  constructor(prisma: PrismaClient) {
    super(prisma);
  }

  definition(): Partial<Gedung> {
    return {
  ...
  protected async store(data: Gedung): Promise<Gedung> {
