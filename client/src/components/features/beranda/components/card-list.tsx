  ...
  if (!dataGedung || dataGedung.length === 0) {
    return (
      <div className="mt-16 text-center py-12 backdrop-blur-sm bg-white/30 rounded-xl border border-[#B7F6B5]/20">
        <h3 className="text-xl font-medium text-[#749C73]">Tidak ada gedung yang tersedia</h3>
        <p className="text-gray-500 mt-2">Silakan coba dengan pencarian atau filter yang berbeda.</p>
      </div>
    );
  }
