...
const Navbar = () => {
    ...
    return (
        <Box
            bg={isScrolled ? `rgba(255, 255, 255, ${0.25 * glassOpacity})` : 'none'}
        ...
        >
            <Container maxW="7xl">
                ...
                <Collapse in={isOpen} animateOpacity>
                    <VStack
                        bg={isScrolled ? "rgba(255, 255, 255, 0.25)" : "rgba(255, 255, 255, 0.15)"}
                        backdropFilter={isScrolled ? "blur(20px)" : "blur(10px)"}
                        border={isScrolled ? "1px solid rgba(255, 255, 255, 0.3)" : "1px solid rgba(255, 255, 255, 0.2)"}
                        borderRadius="20px"
                        boxShadow={isScrolled ? "0 8px 32px rgba(116, 156, 115, 0.15)" : "0 4px 16px rgba(116, 156, 115, 0.1)"}
                        p={4}
                        display={{ md: 'none' }}
                        spacing={4}
                        align="stretch"
